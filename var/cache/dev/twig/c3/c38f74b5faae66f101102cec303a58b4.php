...
class __TwigTemplate_d2a60c7ff6a50f78e455822141e1dbea extends Template
{
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 4
        yield "    <h2>";
        yield ((CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 4, $this->source); })()), "vars", [], "any", false, false, false, 4), "value", [], "any", false, false, false, 4), "id", [], "any", false, false, false, 4)) ? ("Redigera bok") : ("Lägg till ny bok"));
        yield "</h2>
    ";
        // line 5
...
";
    ...
    {
        return array (  83 => 8,  78 => 6,  74 => 5,  69 => 4,  59 => 3,  36 => 1,);
    }
...
{% block body %}
    <h2>{{ form.vars.value.id ? 'Redigera bok' : 'Lägg till ny bok' }}</h2>
    {{ form_start(form) }}
        {{ form_widget(form) }}
        <button type=\"submit\">Spara</button>
    {{ form_end(form) }}
{% endblock %}
", "book/edit.html.twig", "/home/alexander/dbwebb-kurser/mvc/me/report/templates/book/edit.html.twig");
    }
}
