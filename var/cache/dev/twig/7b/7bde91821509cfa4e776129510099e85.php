...
class __TwigTemplate_7620c996ef9baae077d07f33eda09744 extends Template
{
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 6
        yield "    <h1>Alla kort i kortleken</h1>
    <ul class=\"card-ul\">
        ";
        // line 8
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["card"]) {
            // line 9
            yield "            ";
            if (((CoreExtension::getAttribute($this->env, $this->source, $context["card"], "getSuit", [], "method", false, false, false, 9) == "♥") || (CoreExtension::getAttribute($this->env, $this->source, $context["card"], "getSuit", [], "method", false, false, false, 9) == "♦"))) {
                // line 10
                yield "                <li><span style=\"color: red;\">";
...
";
    ...
    {
        return array (  122 => 16,  119 => 15,  113 => 14,  107 => 12,  101 => 10,  98 => 9,  94 => 8,  90 => 6,  80 => 5,  60 => 3,  37 => 1,);
    }
...
{% block body %}
    <h1>Alla kort i kortleken</h1>
    <ul class=\"card-ul\">
        {% for card in deck %}
            {% if card.getSuit() == '♥' or card.getSuit() == '♦' %}
                <li><span style=\"color: red;\">{{ card }}</span></li>
            {% else %}
                <li>{{ card }}</li>
            {% endif %}
        {% endfor %}
    </ul>
    <a href=\"{{ path('show_deck') }}\">Visa kortleken igen</a>
{% endblock %}
", "card/deck.html.twig", "/home/alexander/dbwebb-kurser/mvc/me/report/templates/card/deck.html.twig");
    }
}
